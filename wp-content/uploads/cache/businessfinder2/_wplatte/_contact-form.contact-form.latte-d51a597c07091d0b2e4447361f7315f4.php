<?php //netteCache[01]000595a:2:{s:4:"time";s:21:"0.98733200 1663237082";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:106:"/home/www/npik.online/wp-content/themes/businessfinder2/ait-theme/elements/contact-form/contact-form.latte";i:2;i:1662654481;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.2";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:6:"3.1.10";}}}?><?php

// source file: /home/www/npik.online/wp-content/themes/businessfinder2/ait-theme/elements/contact-form/contact-form.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '0yjqa35nqi')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($element->common('header'), $template->getParameters(), $_l->templates['0yjqa35nqi'])->render() ;$pass = "aitthemes" ;$response_email_address = $element->option('address') ;$response_email_sender = $element->option('sender') ;if (empty($response_email_address)) { $encrypted_email_address = "" ;} else { $encrypted_email_address = openssl_encrypt($response_email_address,"AES-128-ECB",$pass) ;} if (empty($response_email_sender)) { $encrypted_email_sender = "" ;} else { $encrypted_email_sender = openssl_encrypt($response_email_sender,"AES-128-ECB",$pass) ;} ?>
...
<?php $check = rand() ?>
		...
		<input type="hidden" name="response-email-address" value="<?php echo NTemplateHelpers::escapeHtml($encrypted_email_address, ENT_COMPAT) ?>" />
		<input type="hidden" name="response-email-sender" value="<?php echo NTemplateHelpers::escapeHtml($encrypted_email_sender, ENT_COMPAT) ?>" />
...
"><?php echo NTemplateHelpers::escapeHtml($input['value'], ENT_NOQUOTES) ?></textarea>
						<?php if (isset($input['helper']) and $input['helper']) { ?><span class="input-helper"><?php echo $input['helper'] ?>
</span><?php } ?>
...
<?php } ?>
					<span class="input-wrap">
						<input class="input-required" type="text" name="captcha-check" id="<?php echo NTemplateHelpers::escapeHtml($htmlId, ENT_COMPAT) ?>-captcha-check" value="" style="display: none" />
<?php if ($element->option('captchaText') != '') { ?>
							<span class="captcha-text"><i class="fa fa-refresh fa-spin" style="margin-right: 10px"></i> <?php echo NTemplateHelpers::escapeHtml($element->option('captchaText'), ENT_NOQUOTES) ?></span>
<?php } ?>
					</span>
				</span>
			</p>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/contact-form/javascript", ""), array() + get_defined_vars(), $_l->templates['0yjqa35nqi'])->render() ;